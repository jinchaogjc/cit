...
try:
    from .m2f.dense_heads.mask2former_head import \
...
class M2fHead(MMDET_Mask2FormerHead):
    ...
    def loss(self, x: Tuple[Tensor], batch_data_samples: SampleList,
             train_cfg: ConfigType, return_pred=False) -> dict:
    ...
    def predict(self, x: Tuple[Tensor], batch_img_metas: List[dict],
        ...
        # adapt for class-agnostic prediction
        seg_logits = torch.einsum('bqc, bqhw->bqhw', cls_score, mask_pred)
        return seg_logits
