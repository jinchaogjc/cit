...
in_channels = 768
out_indices = [5, 7, 11]
train_class_range = [1, 50]
test_class_range = [1, 50]
...
model = dict(
    ...
    pretrained='checkpoints/ckpt/vit_base_p16_384_20220308-96dfe169.pth',
    backbone=dict(
    ...
    auxiliary_head=None,
    train_cfg=dict(),
    test_cfg=dict(mode='slide', crop_size=(img_size, img_size), stride=(341, 341)),)
...
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='Resize', scale=(2048, img_size), keep_ratio=True),
